...
Revision ID: 8f5a4dfcdcfa
Revises: be6f8ea65a7b
Create Date: 2022-06-08 08:36:51.715881
...
revision = '8f5a4dfcdcfa'
down_revision = 'be6f8ea65a7b'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('seeking_venues', sa.BOOLEAN(), autoincrement=False, nullable=False),
